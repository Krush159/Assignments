...
function EditPatient(props) {
    ...
    const [imageURL, setImageURL] = useState(editData && editData['IMAGE'])
    const mobileRegex = /^[6789]\d{9}$/;

    const data = {
        "firstName": editData && editData['PATIENT_FIRST_NAME'],
        "lastName": editData && editData['PATIENT_LAST_NAME'],
        "selectGender": editData && editData['GENDER'],
        "dob": editData && editData['DOB'],
        "maritalStatus": editData && editData['MARITAL_STATUS'],
        "selectOccupation": editData && editData['OCCUPATION'],
        "mobileNo": editData && editData['MOBILE_NO'],
        "email": editData && editData['EMAIL_ID'],
        "temporaryAddressLine1": editData && editData['TEMPORARY_ADDRESS_LINE1'],
        "temporaryAddressLine2": editData && editData['TEMPORARY_ADDRESS_LINE2'],
        "permanentAddressLine1": editData && editData['PERMANENT_ADDRESS_LINE1'],
        "permanentAddressLine2": editData && editData['PERMANENT_ADDRESS_LINE2'],
        "imageFile": imageURL,
    ...
    return (
        ...
        >
            <Grid container >
                <Grid item xs={12}>
                    <DialogTitle id="alert-dialog-title" onClose={props.close}>{"Edit Patient Profile"}</DialogTitle>
                    <DialogContent>
                            ...
                            <Grid item xs={12}>
                                <Formik
                                    ...
                                    onSubmit={(values, { setSubmitting, resetForm }) => {
                                        ...
                                        // const updatedDirectory = profileDirectory.map(item => [obj].find(ele => ele['PATIENT_ID'] === item['PATIENT_ID']) || item)
...
const mapDispatchToProps = (dispatch) => {
    return {
        edit: (payload) => dispatch(editPatient(payload))
    }
}
